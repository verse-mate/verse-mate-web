...
VERSIONS: list[dict] = [
    ...
    {'key': 'UKRKL',  'ebible_id': 'ukr1871',   'language': 'uk', 'title': 'Переклад Куліша (НЗ)',         'license': 'Public Domain', 'license_url': '', 'attribution': 'Новий Завіт, переклад П. Куліша. Public domain.', 'expect': 'nt'},
