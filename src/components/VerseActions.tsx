    ...
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 bg-card rounded-t-2xl shadow-lg border-t border-border animate-slide-up max-w-lg mx-auto">
        ...
        <div className="grid grid-cols-3 gap-1 p-4">
          ...
          <button onClick={() => setShowAddNote(true)} className="flex flex-col items-center gap-1.5 py-3 rounded-lg hover:bg-secondary transition-colors">
          ...
          <button onClick={viewCommentary} className="flex flex-col items-center gap-1.5 py-3 rounded-lg hover:bg-secondary transition-colors">
            <BookOpen size={20} className="text-foreground" />
            <span className="text-xs text-muted-foreground">Commentary</span>
          </button>
          <button onClick={viewInsight} className="flex flex-col items-center gap-1.5 py-3 rounded-lg hover:bg-secondary transition-colors">
