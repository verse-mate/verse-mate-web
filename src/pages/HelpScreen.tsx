          ...
          <>
            ...
            <div className="mt-5">
              ...
              <textarea
                ...
                rows={5}
                className="mt-1.5 w-full rounded-xl bg-dark-raised border border-dark px-4 py-3 text-[14px] text-dark-fg placeholder:text-dark-muted/70 focus:outline-none focus:ring-2 focus:ring-[hsl(var(--accent))] resize-none"
              />
            </div>
          </>
        )}
