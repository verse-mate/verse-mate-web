  ...
  return (
    <div className="flex flex-col h-full bg-white text-[#1B1B1B]">
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-8">
        <div className="rounded-2xl overflow-hidden bg-[#f8f9fa] mt-2 aspect-[4/5]">
          <img
        ...
        <h1 className="text-[22px] font-bold text-[#1B1B1B] mt-6 leading-tight">
        ...
        <p className="text-[14px] text-[#818990] mt-3 leading-relaxed">
