...
export default function CoachLeaderScreen() {
  ...
  // Unlike the dashboard, this screen has no deep-link path: `selectedId` is
  // local state set only from a report already in this list (or cleared to
  // null), so a miss is unreachable and `latest` is the correct default.
