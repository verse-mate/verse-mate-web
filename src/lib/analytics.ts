 ...
 * `frontend-base/analytics` module so identify/track call sites can be
 * ported with minimal churn. All calls no-op when PostHog is not
 * initialized (i.e. when VITE_POSTHOG_KEY is not set in the build env).
 */
