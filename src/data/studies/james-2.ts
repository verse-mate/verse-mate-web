  ...
  steps: [
    ...
    },
    {
      ...
      items: [
        ...
        { tag: 'TO WHOM', q: 'To whom is it written?', a: '"The twelve tribes who are dispersed abroad" (1:1) — Jewish believers scattered across the Roman world. Chapter 2 reveals an assembly that is mixed economically: poor brothers in dirty clothes alongside rich visitors with gold rings (2:2).' },
        ...
        { tag: 'WHERE', q: 'What is the chapter\'s setting?', a: 'The assembly (Greek *synagōgē*, 2:2) — the Jewish-Christian gathering. The chapter also names the courts (2:6) where the rich oppress, and the household scene (2:15-16) where the brother is without clothing or food.' },
        { tag: 'WHY', q: 'Why does the chapter matter?', a: 'James 1:27 defined "pure and undefiled religion" as visiting orphans and widows and remaining unstained by the world. Chapter 2 picks up exactly there: how can a person of living faith favor the wealthy assembly visitor over the poor one? The chapter develops the faith / works clusters seeded in 1:22.' },
        { tag: 'HOW', q: 'How does the chapter teach?', a: 'Pastoral exhortation built around two test cases (the partial assembly, 2:1-13; the empty profession, 2:14-26) and two examples from Israel\'s history (Abraham and Rahab, 2:21-25). Living faith is demonstrated by deed.' },
      ],
    },
    {
      number: 3,
