  ...
  steps: [
    ...
    },
    {
      ...
      items: [
        ...
        { tag: 'TO WHOM', q: 'To whom is it written?', a: '"The twelve tribes who are dispersed abroad" (1:1). Chapter 5 addresses the unjust rich (5:1-6), the suffering brethren waiting for the Lord (5:7-12), the sick and sin-burdened in the assembly (5:13-18), and any who would turn back a wanderer (5:19-20).' },
        ...
        { tag: 'WHERE', q: 'What is the chapter\'s setting?', a: 'The chapter ranges across agricultural fields where wages are withheld (5:4), the assembly where elders pray over the sick (5:14), and Elijah\'s drought-stricken Israel (5:17-18, 1 Kings 17-18). Eschatologically, it is set "in the last days" (5:3).' },
        { tag: 'WHY', q: 'Why does the chapter matter?', a: "James 4 ended with the rebuke of arrogant planning. Chapter 5 opens by pressing that warning harder against the unjust rich (already glimpsed in 2:6-7), then pivots to the answering virtue: patience until the coming of the Lord. The chapter closes the letter the way it opened (1:2-4) — endurance, the same Greek word (hupomone) — and adds prayer as the means by which patience is sustained." },
        { tag: 'HOW', q: 'How does the chapter teach?', a: 'Four pastoral movements: woe to the unjust rich (5:1-6) → patience until the coming (5:7-12) → prayer for every season (5:13-18) → the ministry of restoration (5:19-20). The letter ends without a benediction — an unfinished sentence: someone is wandering; go.' },
      ],
    },
    {
      number: 3,
