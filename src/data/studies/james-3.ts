...
export const JAMES_3_STUDY: InductiveStudy = {
  ...
  steps: [
    ...
    },
    {
      ...
      items: [
        { tag: 'WHO', q: 'Who wrote it?', a: 'James, the half-brother of Jesus (Matthew 13:55; Galatians 1:19), leader of the Jerusalem church (Acts 15:13; 21:18). He includes himself among the teachers ("we will incur a stricter judgment," 3:1) — a Jerusalem-church elder writing pastorally.' },
        { tag: 'TO WHOM', q: 'To whom is it written?', a: '"The twelve tribes who are dispersed abroad" (1:1). Chapter 3 narrows the focus to teachers and would-be teachers in the assembly, then widens to anyone whose tongue reveals which wisdom is operating.' },
        ...
        { tag: 'WHERE', q: 'What is the chapter\'s setting?', a: 'The chapter\'s only literal location is "set on fire by hell" (3:6, Greek *Geenna* — the Valley of Hinnom south of Jerusalem). The natural-world locations (fountain, fig tree, vine, salt water) are similes, not geography.' },
        { tag: 'WHY', q: 'Why does the chapter matter?', a: 'James 1:26 warned that an unbridled tongue is evidence of worthless religion. Chapter 3 returns to the tongue and brings it into open view: small organ, disproportionate power. Then it widens into a diagnostic — *what kind of wisdom* is producing your speech?' },
        { tag: 'HOW', q: 'How does the chapter teach?', a: 'Two halves: (1) the tongue is uncontrollable (3:1-12), three similes proving disproportion. (2) the two wisdoms are visible (3:13-18), with seven qualities of wisdom from above set against jealousy and selfish ambition.' },
      ],
    },
    {
      number: 3,
