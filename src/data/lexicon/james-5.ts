...
const VERSES: ChapterAlignment['verses'] = {
  ...
  7: [
    { surface: 'patient', lemma: 'makrothymia', contextual:
  ...
  8: [
    { surface: 'patient', lemma: 'makrothymia' },
  ...
  10: [
    ...
    { surface: 'patience', lemma: 'makrothymia' },
    { surface: 'Lord', lemma: 'kyrios' },
  ],
  11: [
    { surface: 'steadfast', lemma: 'hypomone' },
    { surface: 'endured', lemma: 'hypomone', contextual:
  ...
  16: [
    ...
    { surface: 'righteous', lemma: 'dikaiosyne' },
  ],
  17: [
  ...
  18: [
    { surface: 'prayed', lemma: 'proseuchomai' },
    { surface: 'rain', lemma: 'hyetos', contextual:
...
const THEME_LEMMAS = ['hypomone', 'makrothymia', 'parousia'];
